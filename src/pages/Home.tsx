 ...
 *   MealBudgetPlanner -> the app's display name
 *   한 달 식비 예산을 입력하면 끼니별 허용 금액과 소비 패턴 피드백을 매일 제공하는 식비 관리 앱    -> the one-line description
 */
